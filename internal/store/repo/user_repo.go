...
func (r *userRepo) UpdateCredentials(ctx context.Context, id int64, email, passwordHash string) (*domain.User, error) {
	if err := r.q.UpdateUser(ctx, id, email, passwordHash); err != nil {
		return nil, err
	}
